...
import (
	...
	testdata "github.com/liansyyy/hade/framework/gin/testdata/protoexample"
)
...
//
//	//assert.Regexp(t, `^(.*/vendor/)?(github\.com/liansyyy/hade/framework/gin\.){1}(TestContextHandlerNames\.func.*){0,1}(handlerNameTest.*){0,1}`, c.HandlerName())
//
//	assert.Regexp(t, "^(.*/vendor/)?github.com/liansyyy/hade/framework/gin.handlerNameTest$", c.HandlerName())
//}
